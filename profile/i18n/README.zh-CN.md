...
| [`canon-playbooks`](https://github.com/the-ai-theorem/canon-playbooks) | 面向各供应商 / 各智能体的应用手册——Claude Code, Cursor, Codex, Gemini, …（领域中立） | Planned |
| [`canon-examples`](https://github.com/the-ai-theorem/canon-examples) | 在真实工作流中应用 Canon 的示例项目 | Planned |
